...
from megan.model.megan_modules.decoder import MeganDecoder
from megan.model.megan_modules.encoder import MeganEncoder
...
default_bond_features = 'bond_type', 'bond_stereo'
...
class Megan(nn.Module):
    def __init__(self, n_atom_actions: int, n_bond_actions: int, prop2oh: dict,
                 bond_emb_dim: int = 32, hidden_dim: int = 1024, stateful: bool = True,
