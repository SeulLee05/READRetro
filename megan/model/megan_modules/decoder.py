...
from megan.model.graph.gat import MultiHeadGraphConvLayer
...
class MeganDecoder(nn.Module):
    def __init__(self, hidden_dim: int, bond_emb_dim, n_atom_actions: int, n_bond_actions: int,
                 n_fc: int = 2, n_decoder_conv: int = 2, dec_residual: bool = True, bond_atom_dim: int =128,
                 atom_fc_hidden_dim: int = 128, bond_fc_hidden_dim: int = 128, dec_dropout: float = 0.0,
